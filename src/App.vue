...
<template>
  <div class="min-h-screen w-full relative overflow-hidden">
    ...
    <div class="bg-image fixed inset-0 bg-cover bg-center -z-10"
      :style="{ backgroundImage: `url(${bgImage})` }"></div>
    
    <!-- Gradient Overlay (becomes solid dark during slideshow) -->
    <div class="bg-overlay absolute inset-0 bg-gradient-to-l from-black/50 to-black/0 pointer-events-none z-0"></div>

    <!-- Solid Dark Overlay for Slideshow -->
    <div class="slideshow-overlay fixed inset-0 bg-black/95 pointer-events-none z-15 opacity-0 transition-opacity duration-800"></div>
    ...
    <div v-if="isPlaying" class="slideshow-controls">
      ...
      <div class="control-container">
        ...
        <div class="control-buttons">
          ...
          >
            <svg v-if="!isPaused" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="btn-icon">
              <path fill-rule="evenodd" d="M6.75 5.25a.75.75 0 01.75-.75H9a.75.75 0 01.75.75v13.5a.75.75 0 01-.75.75H7.5a.75.75 0 01-.75-.75V5.25zm7.5 0A.75.75 0 0115 4.5h1.5a.75.75 0 01.75.75v13.5a.75.75 0 01-.75.75H15a.75.75 0 01-.75-.75V5.25z" clip-rule="evenodd" />
            </svg>
            <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="btn-icon ml-0.5">
    ...
    <!-- Bottom Left Blur -->
    <div class="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 absolute left-[-10%] bottom-0 bg-black/75 blur-[50px]"></div>
  </div>
</template>
...
.control-container:hover {
  ...
  box-shadow: 0 12px 40px rgba(0, 0, 0, 0.4), 0 4px 12px rgba(99, 102, 241, 0.2);
...
.progress-dot.active .dot-inner {
  width: 2rem;
  background: white;
  box-shadow: 0 0 12px rgba(255, 255, 255, 0.5), 0 0 24px rgba(99, 102, 241, 0.3);
}
