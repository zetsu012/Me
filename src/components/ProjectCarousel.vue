<template>
  <div class="relative lg:absolute lg:top-[15vh] w-full overflow-hidden pb-8 sm:pb-12 lg:pb-16">
    <div class="relative px-4 sm:px-6 lg:px-0">
      ...
      >
        ...
        >
          <div class="relative">
            <!-- Project Image -->
            <div class="w-64 h-40 sm:w-72 sm:h-48 lg:w-80 lg:h-52 rounded-2xl sm:rounded-3xl shadow-[inset_0px_0px_17.4px_21px_rgba(0,0,0,0.25)] transition-transform duration-300 group-hover:scale-105 bg-gradient-to-br from-indigo-500/30 to-purple-600/30 flex items-center justify-center relative overflow-hidden">
              <!-- GitHub Icon -->
              <svg class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-white/60" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Project Title -->
            <div class="mt-3 sm:mt-4 text-white text-lg sm:text-xl font-medium" 
